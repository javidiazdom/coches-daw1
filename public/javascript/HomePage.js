...
function setData (content) {
    content.forEach((element, index) => {
        ...
        document.getElementsByClassName('desktop-img')[index].src = "192.168.122.200" + element.review_image
        document.getElementsByClassName('movil-img')[index].src = "192.168.122.200" + element.review_image
...
function populateSelect() {
    ...
    xhr.open('GET', '192.168.122.200/homepage');
    xhr.send();
}
